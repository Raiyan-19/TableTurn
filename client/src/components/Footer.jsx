...
export const Footer = () => {
  ...
  return (
    <footer className="mt-20 border-t border-slate-200 dark:border-white/10 bg-slate-100 dark:bg-surface-400 pt-14 pb-10 text-slate-600 dark:text-slate-400 text-xs transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-slate-200 dark:border-white/10">
          ...
          <div className="md:col-span-1">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="font-display text-xl font-extrabold text-slate-950 dark:text-white">
                  Table<span className="text-gold-500">Turn</span>
                </span>
                <span className="text-[9px] font-bold uppercase tracking-wider ml-1 px-1.5 py-0.5 rounded bg-gold-500/10 text-gold-600 dark:text-gold-400 border border-gold-500/20">
                  Bangladesh
                </span>
              </div>
            </div>
            ...
            <div className="mt-4 flex items-center gap-2 text-[11px] text-emerald-600 dark:text-emerald-400 font-bold">
          ...
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-slate-950 dark:text-white mb-3 flex items-center gap-1.5">
              ...
              {BANGLADESH_DIVISIONS.map((div) => (
                <li key={div}>
                  <button
                    ...
                    className="hover:text-gold-600 dark:hover:text-gold-400 text-slate-700 dark:text-slate-300 transition-colors text-left"
                  >
                    {div} Division Dining
                  </button>
                </li>
          ...
          <div>
            ...
            <div className="p-3 rounded-2xl bg-white dark:bg-surface-100 border border-slate-200 dark:border-white/5 space-y-1 shadow-sm">
              <p className="text-xs font-bold text-slate-900 dark:text-white">Concierge Hotline (BD):</p>
              <a 
                href="tel:01571284636"
                className="font-mono text-xs text-gold-600 dark:text-gold-400 font-bold hover:underline transition-colors block"
              >
                +880 1571-284636 (01571284636)
              </a>
              <p className="text-[10px] text-slate-500 dark:text-slate-400">Daily: 10:00 AM – 11:30 PM</p>
            </div>
            <button
              onClick={() => setIsHostPortalOpen(true)}
              className="mt-3 w-full py-2 px-3 rounded-xl bg-gold-500/10 hover:bg-gold-500/20 text-gold-700 dark:text-gold-400 border border-gold-500/30 text-xs font-bold text-center transition-all flex items-center justify-center gap-1.5 shadow-sm"
            >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              onClick={() => setIsHostPortalOpen(true)}
              className="hover:text-gold-600 dark:hover:text-gold-400 text-gold-600 dark:text-gold-400 font-semibold cursor-pointer underline"
            >
              Host Partner Portal
            </button>
          </div>
